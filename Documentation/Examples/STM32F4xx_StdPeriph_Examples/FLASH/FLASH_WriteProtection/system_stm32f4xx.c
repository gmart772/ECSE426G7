/**
  ******************************************************************************
  * @file    FLASH/FLASH_WriteProtection/system_stm32f4xx.c
...
/*
  ...
  NORSRAMTimingStructure.FSMC_AddressHoldTime = 1;
  NORSRAMTimingStructure.FSMC_DataSetupTime = 2;
  NORSRAMTimingStructure.FSMC_BusTurnAroundDuration = 1;
  NORSRAMTimingStructure.FSMC_CLKDivision = 2;
  NORSRAMTimingStructure.FSMC_DataLatency = 2;
  NORSRAMTimingStructure.FSMC_AccessMode = FSMC_AccessMode_A;
