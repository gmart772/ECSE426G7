/**
  @page CortexM4_BitBand CortexM4 BitBand example
  ...
  * @brief   Description of the CortexM4 BitBand example.
  ******************************************************************************
  *
...
@par Directory contents 
  ...
  - CortexM/BitBand/system_stm32f4xx.c  STM32F4xx system source file
...
@par Hardware and Software environment
  ...
  - This example has been tested with STMicroelectronics STM324xG-EVAL (STM32F40xx/
    ...
    boards and can be easily tailored to any 
