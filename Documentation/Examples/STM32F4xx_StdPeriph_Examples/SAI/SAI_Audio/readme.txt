...
It allows to play an audio file through the SAI peripheral and using the external
codec implemented on the STM324x9I_EVAL board.
...
with 4 time slot (2 time slots left/right channels for headphone and 2 time slots left/right 
...
@par Directory contents 
  ...
  - SAI/SAI_Audio/main.h              header file for Main program
