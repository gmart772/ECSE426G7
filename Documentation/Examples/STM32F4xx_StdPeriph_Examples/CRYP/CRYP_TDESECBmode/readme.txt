/**
  @page CRYP_TDESECBmode  Encrypt and Decrypt data using TDES Algo in ECB mode, with DMA

  @verbatim
  ******************** (C) COPYRIGHT 2013 STMicroelectronics *******************
  * @file    CRYP/CRYP_TDESECBmode/readme.txt 
...
@par Directory contents 
  ...
  - CRYP/CRYP_TDESECBmode/system_stm32f4xx.c   STM32F4xx system clock configuration file
  - CRYP/CRYP_TDESECBmode/stm32f4xx_conf.h     Library Configuration file
  - CRYP/CRYP_TDESECBmode/stm32f4xx_it.h       Interrupt handlers header file
  - CRYP/CRYP_TDESECBmode/stm32f4xx_it.c       Interrupt handlers
  - CRYP/CRYP_TDESECBmode/main.c               Main program
  - CRYP/CRYP_TDESECBmode/main.h               Main header
