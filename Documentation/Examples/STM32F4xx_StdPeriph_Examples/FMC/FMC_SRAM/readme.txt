...
on STM32437I_EVAL or STM324x9I_EVAL board. It uses an  associate driver developed 
to interface with the indicated SRAM device.
...
The user can chose his own configuration by commenting/uncommenting the defines 
...
@par Directory contents
 ...
 - FMC/FMC_SRAM/stm32f4xx_it.h              Header for stm32f4xx_it.c
 - FMC/FMC_SRAM/main.h                      Header for main.c module 
...
@par Hardware and Software environment 
  ...
  - This example has been tested with STMicroelectronics STM32437I-EVAL 
    (STM32F427xx/STM32F437xx Devices) and STM324x9I-EVAL 
